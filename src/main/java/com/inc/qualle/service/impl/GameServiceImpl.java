...
public class GameServiceImpl implements GameService {
    ...
    public Map<String, List<GameSimpleDto>> getForGamesPage() {
        ...
        for (Product product : products) {
            ...
            switch (product.getCategory().getTitle().trim().toLowerCase()) {
    ...
    private GameDto toDto(Product product) {
        GameDto dto = new GameDto(product.getName(), product.getDescription(), product.getPrice(), product.getDeveloper().getTitle(), product.getCategory().getTitle(), product.getImg());
    ...
    private GameSimpleDto toSimpleDto(Product product) {
        GameSimpleDto dto = new GameSimpleDto(product.getName(), product.getPrice(), product.getImg());
        dto.setId(product.getId());
        return dto;
    }
